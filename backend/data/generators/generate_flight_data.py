...
# Output directory for generated data (relative to project root)
...
trajectory_path = os.path.join(OUTPUT_DIR, "flight_trajectory_data.csv")
...
conflict_path = os.path.join(OUTPUT_DIR, "aircraft_conflict_data.csv")
...
anomaly_path = os.path.join(OUTPUT_DIR, "anomaly_detection_data.csv")
anomaly_df.to_csv(anomaly_path, index=False)
print(f"Generated {anomaly_path}")
