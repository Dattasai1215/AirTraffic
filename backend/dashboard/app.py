...
# This file lives at backend/dashboard/app.py → go up 2 levels to reach root
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..")))

from backend.services.opensky.opensky_fetcher import fetch_active_flights, LAMIN, LAMAX, LOMIN, LOMAX
...
from backend.services.alerts.collision_alert import get_alert
